...
export default function PayPage() {
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="bg-linear-to-br from-slate-900 to-slate-800 text-white py-12 md:py-20">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {steps.map((step) => (
              <div
                key={step.number}
                className="bg-white rounded-2xl shadow-md p-6 hover:shadow-lg transition-shadow border-l-4 border-orange-500"
              >
          ...
          <div className="mt-12 bg-linear-to-br from-blue-50 to-blue-100 rounded-2xl p-8 border border-blue-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div>
                ...
                <p className="text-lg text-slate-900">Your Phone Number</p>
          ...
          <div className="mt-16">
            ...
            <div className="space-y-4">
              {[
                ...
                >
                  <summary className="px-6 py-4 font-semibold text-slate-900 flex items-center justify-between select-none">
                    {faq.q}
      ...
      {showSuccess && (
        <div className="fixed top-20 left-4 right-4 md:left-auto md:right-4 bg-green-500 text-white rounded-lg shadow-lg p-4 flex items-center gap-3 animate-pulse z-50">
          <CheckCircle size={24} />
          <div>
            <p className="font-semibold">Payment Successful!</p>
            <p className="text-sm">You will receive an SMS confirmation shortly</p>
          </div>
        </div>
      )}

      {/* CTA Section */}
      <section className="py-16 md:py-24 bg-linear-to-r from-slate-900 to-slate-800 text-white">
